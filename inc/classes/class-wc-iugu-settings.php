...
class WC_IUGU_Settings extends WC_Settings_API
{
     ...
     **/
    public $logger;
    public $iugu_account_id;
    public $iugu_api_token;
    public $iugu_status_pending;
    public $iugu_status_processing;
    public $iugu_status_partial_payment;
    public $iugu_sandbox;
    public $iugu_debug;
    public $iugu_customer_id_start_date_validation;
